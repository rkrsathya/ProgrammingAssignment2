...
## This function gets input as vector from the above function and
## gets the inverse from cache or 
## computes inverse of a matrix and set it in cache, 
## if inverse not available in the cache.
